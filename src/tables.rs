...
pub const KING_TABLE: [Bitboard; 64] =
  ...
  , Bitboard::new(29442496)
  , Bitboard::new(58884992)
  ...
  , Bitboard::new(7537278976)
  , Bitboard::new(15074557952)
  ...
  , Bitboard::new(1929543417856)
  , Bitboard::new(3859086835712)
  ...
  , Bitboard::new(493963114971136)
  , Bitboard::new(987926229942272)
  ...
  , Bitboard::new(126454557432610816)
  , Bitboard::new(252909114865221632)
  ...
  , Bitboard::new(13925622629038817280)
  , Bitboard::new(9404501184368082944)
